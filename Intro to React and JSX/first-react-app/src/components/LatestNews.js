                ...
                <div className="row mt-5">
                    <div className="col-lg-4 py-3 wow fadeInUp">
                        <div className="card-blog">
                            ...
                            <div className="body">
                                <h5 className="post-title"><a href="source">Source of Content Inspiration</a></h5>
                                <div className="post-date">Posted on <a href="date">27 Jan 2020</a></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-4 py-3 wow fadeInUp">
                        <div className="card-blog">
                            ...
                            <div className="body">
                                <h5 className="post-title"><a href="sc">Source of Content Inspiration</a></h5>
                                <div className="post-date">Posted on <a href="date">27 Jan 2020</a></div>
                            </div>
                        </div>
                    </div>
