        ...
        <header>
            <nav className="navbar navbar-expand-lg navbar-light bg-white sticky" data-offset="500">
                <div className="container">
                    <a href="nav" className="navbar-brand">Seo<span className="text-primary">Gram.</span></a>
                    ...
                    <div className="navbar-collapse collapse" id="navbarContent">
                        <ul className="navbar-nav ml-auto">
                            ...
                            <li className="nav-item">
                                <a className="btn btn-primary ml-lg-2" href="analytics">Free Analytics</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="page-banner home-banner">
                    <div className="row align-items-center flex-wrap-reverse h-100">
                        <div className="col-md-6 py-5 wow fadeInLeft">
                            ...
                            <a href="watch" className="btn btn-primary btn-split">Watch Video <div className="fab"><span className="mai-play"></span></div></a>
                        </div>
