                ...
                <div className="row mt-5">
                    <div className="col-lg-4 py-3 wow zoomIn">
                        <div className="card-pricing">
                            ...
                            <div className="footer">
                                <a href="subscribe1" className="btn btn-pricing btn-block">Subscribe</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-4 py-3 wow zoomIn">
                        <div className="card-pricing marked">
                            ...
                            <div className="footer">
                                <a href="subscribe2" className="btn btn-pricing btn-block">Subscribe</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-4 py-3 wow zoomIn">
                        <div className="card-pricing">
                            ...
                            <div className="footer">
                                <a href="subscribe3" className="btn btn-pricing btn-block">Subscribe</a>
                            </div>
                        </div>
                    </div>
